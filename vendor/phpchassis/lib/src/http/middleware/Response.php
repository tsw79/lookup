...
class Response extends Message implements ResponseInterface {
   ...
   *  The constructor is not defined by PSR-7, but we provide it for convenience, allowing a developer to create a
   *  Response instance with all parts intact. We use methods from Message and constants from the Constants class to
   ...
   * on RFC 7231.
   *      Note the use of the PHP 7 null coalesce operator ?? that returns the first non-null item out of
