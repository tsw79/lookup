...
// ------------------------------------------------------------------------------------
// We are going to interpret the request target as the originally requested URI in the
// form of a string. Bear in mind that our Uri class has methods that will parse this
// into its component parts, hence our provision of the $uriObj property. In the
// case of withRequestTarget(), notice that we run getUri() that performs the
// aforementioned parsing process:
// ------------------------------------------------------------------------------------
